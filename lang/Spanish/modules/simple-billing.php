...
define('skrill_merchant_id', "Identificación del comerciante");
...
define('starting_installations', "Inicio de la instalación...");
...
define('url_for_manual_install', "URL para la instalación manual");
