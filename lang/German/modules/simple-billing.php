...
define('OGP_LANG_skrill_secret_word_info', "The password must be set from your Skrill merchant account,<br>at <b>Settings</b> click on <b>Developer Settings</b>.<br>If this option is not listed send an email to <i>merchantservices@skrill.com</i>.");
...
define('OGP_LANG_invoice_duration', "Rechnungszyklus");
define('OGP_LANG_calculate_price', "Preis berechnen");
define('OGP_LANG_buy', "KAUFEN");
define('OGP_LANG_back_to_list', "Zurück zur Liste");
...
define('OGP_LANG_to_purchase_a_service', "um einen Service zu kaufen");
define('OGP_LANG_available_services', "Verfügbare Services");
define('OGP_LANG_payment_is_pending_of_approval', "Die Zahlung wurde noch nicht bestätigt.");
define('OGP_LANG_back_to_your_cart', "Zurück zum Wahrenkorb");
define('OGP_LANG_expired', "Abgelaufen");
define('OGP_LANG_removed', "Entfernt");
define('OGP_LANG_extended', "Verlängert");
define('OGP_LANG_installation_and_expiration_date', "Installation und Ablaufdatum");
define('OGP_LANG_expiration_date', "Verfallsdatum");
define('OGP_LANG_removal_date', "Datum des Vertragsendes");
define('OGP_LANG_installation_date', "Installationsdatum");
define('OGP_LANG_enable_server', "Server aktivieren");
define('OGP_LANG_success', "Erfolgreich");
define('OGP_LANG_redirecting_to_game_monitor', "Weiterleitung zum Game Monitor...");
define('OGP_LANG_starting_installations', "Starte die Installation...");
define('OGP_LANG_order_id', "Bestell-Nr.");
define('OGP_LANG_home_name', "Home Name");
define('OGP_LANG_tax', "Steuer");
define('OGP_LANG_pay_from', "Zahlung von %s");
define('OGP_LANG_set_as_paid', "Als bezahlt markieren");
define('OGP_LANG_create_server', "Server erstellen");
...
define('OGP_LANG_add_to_cart', "In den Wahrenkorb.");
...
define('OGP_LANG_there_are_no_orders_in_cart', "Keine Produkte im Wahrenkorb");
define('OGP_LANG_redirecting_to', "Weiterleitung zu %s");
...
define('OGP_LANG_service_image_url', "Bild-URL-Dienst");
define('OGP_LANG_remove_service', "Remote Dienst");
define('OGP_LANG_add_service', "Dienst hinzufügen");
define('OGP_LANG_current_services', "Aktuelle Dienste");
define('OGP_LANG_max_slot_qty', "Max. Slot Anzahl");
define('OGP_LANG_min_slot_qty', "Min. Slot Anzahl");
define('OGP_LANG_ftp_account', "FTP Account");
define('OGP_LANG_select_install_method', "Installationsmethode auswählen");
define('OGP_LANG_url_for_manual_install', "URL für manuelle Installation");
define('OGP_LANG_description', "Beschreibung");
define('OGP_LANG_image_url', "Grafik-URL");
define('OGP_LANG_access_rights', "Rechte");
define('OGP_LANG_allow_update', "Update erlauben");
define('OGP_LANG_allow_file_management', "Erlaube Datei-Management");
define('OGP_LANG_allow_parameter_usage', "Parameterverwendung zulassen");
define('OGP_LANG_allow_extra_parameters_usage', "Verwendung von zusätzlichen Parametern zulassen");
define('OGP_LANG_allow_ftp_usage', "Verwendung von FTP zulassen");
define('OGP_LANG_allow_custom_fields', "Benutzerdefinierte Felder zulassen");
...
define('OGP_LANG_manual_from_url', "Manuell von URL");
define('OGP_LANG_business', "Geschäft");
define('OGP_LANG_business_email', "Business Email");
define('OGP_LANG_game_server_order', "Game Server Bestellung");
define('OGP_LANG_item', "Artikel");
define('OGP_LANG_slot_cost', "Kosten/Slot");
define('OGP_LANG_slot_quantity', "Slotanzahl");
